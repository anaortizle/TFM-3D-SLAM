...
def droid_visualization(video, save_path, device="cuda:0"):
    ...
    droid_visualization.filter_thresh = 0.02  #0.005

    # Verifica si la carpeta save_path existe, si no, la crea
    ...
    def animation_callback(vis):
        ...
        with torch.no_grad():
            ...
            """
            # Save poses individually
            for ix, cam_actor in droid_visualization.cameras.items():
                cam_filename = f"{save_path}/camera_{ix}.ply"
                o3d.io.write_line_set(cam_filename, cam_actor, write_ascii=False)
            """    
            ### end ###
